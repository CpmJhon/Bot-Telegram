...
case 'runtime':{
    alfixd.deleteMessage().catch(() => {});
      reply(`Cpm_Jhon BOTZ Online ${runtime(process.uptime())}`)
    }
  break  
...
if (!isCreator) return reply("khusus Cpm_Jhon")
...
let poke = 
`Hi 👋 ${pushname} saya adalah assisten bot yang di buat oleh Cpm_Jhon, Jika menemukan Error Silahkan Report ke owner
...
Original Script || By Cpm_Jhon BOTZ`
alfixd.replyWithPhoto(
        global.pp, {
            caption: poke,
    reply_markup: {
